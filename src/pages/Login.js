...
// ─── Brand tokens (consistent with rest of app) ───────────────────────────────
const BRAND  = '#0C3F44';
const ACCENT = '#13C296';
const CREAM  = '#F5F0E8';
const DARK   = '#0D1B1E';
...
const Onboarding = ({ onDone }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: slide.bg }}>
      {/* Decorative blobs */}
      <View style={[styles.blob, { width: 280, height: 280, top: -60, right: -80, opacity: 0.12 }]} />
      <View style={[styles.blob, { width: 180, height: 180, bottom: 120, left: -50, opacity: 0.08 }]} />
